...
# from tensor_utils import extract_non_diagonal_matrix
# from FOCALModules import split_features
...
class FOCALLoss(nn.Module):
    ...
    def forward(self, mod_features1, mod_features2, index=None):
        ...
        for mod in self.modalities:
            reshaped_mod_features1[mod] = mod_features1.reshape(-1, seq_len, mod_features1.shape[-1])
            reshaped_mod_features2[mod] = mod_features2.reshape(-1, seq_len, mod_features2.shape[-1])
